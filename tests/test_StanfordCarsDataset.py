...
class TestStanfordCars(TestCase):
    ...
    def setUp(self) -> None:
        self.tmp_downlaod_dir = "tmp_download_stanford_cars"
    ...
    def test_download_dataset(self):
        ...
        download_dataset_stanford_cars(_dir, "https://github.com/fabian57fabian/prototypical-networks-few-shot-learning/releases/download/v0.0-unit-tests-dataset-mini_imagenet/stanford_cars.tar.xz")
